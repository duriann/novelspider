...
public class AVMainYaZhouSeTu extends AbstractDownload{
	private static Log log = LogFactory.getLog(AVMainYaZhouSeTu.class);
	...
	public void run() {
		...
		// 文件保存路径
		final String destination = "I://ccc711//yazhousetu//";
		// 打算开启的线程数
		...
		new Thread() {
			public void run() {
				String path = "";
				for (int i = 1; i <= 99; i++) {
					path = "https://www.122cf.com/htm/piclist2/"+i+".htm";
