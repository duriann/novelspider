...
public class TotalMain extends AbstractDownload {
	private static Log log = LogFactory.getLog(TotalMain.class);

	public void run() {

		// 文件保存路径
		final String destination = "I://avgle//total//";
		...
		new Thread() {
			public void run() {
				...
				for (int i = 1; i <= 9999; i++) {
					path = "https://avgle.com/videos?page=" + i;
