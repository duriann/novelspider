...
public class TeenMain extends AbstractDownload {
	private static Log log = LogFactory.getLog(TeenMain.class);

	public void run() {

		// 文件保存路径
		final String destination = "I://avgle//torrent//teen//";
		...
		new Thread() {
			public void run() {
				String path = "";
				for (int i = 1; i <= 99; i++) {
					path = "https://avgle.com/videos/teen?page=" + i;
